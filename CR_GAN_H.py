...
def main(win_size=20, step_size=1, eps=3000, n_crit=5):
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch == 500:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_500' + '.pth')

        if epoch == 1000:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_1000' + '.pth')

        if epoch == 1500:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_1500' + '.pth')

        if epoch == 2000:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_2000' + '.pth')

        if epoch == 2500:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_2500' + '.pth')

        if epoch == 3000:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_3000' + '.pth')

        if epoch == 3500:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_3500' + '.pth')

        if epoch == 4000:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_4000' + '.pth')

        if epoch == 4500:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_4500' + '.pth')

        if epoch == 5000:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_5000' + '.pth')

        if epoch == 5500:
            torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '_5500' + '.pth')

        if epoch % 1 == 0:
            # print(f'Epoch: {epoch}/{epochs} D_Loss: {D_loss.item():.4f} D_z: {np.mean(D_z_value):.4f}±{np.var(D_z_value):.4f} D_x: {np.mean(D_x_value):.4f}±{np.std(D_x_value):.4f} GP: {grad_penalty:.4f} G_Loss: {G_loss.item():.4f} Time: {(time.time() - start_time)/60:.1f}m')
    ...
    torch.save(G.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/generator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '.pth')
    torch.save(D.state_dict(), 'C:/Users/D255728/Documents/ProyectoGAN/model/CR_H/discriminator_CR_H_' + str(K) + '_' + str(S) + '_' + str(epochs) + '_' + str(generator_learning_rate) + '_' + str(dynamic_LR) + '_' + str(n_critic) + '.pth')
